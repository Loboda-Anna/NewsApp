...
})({"abNf4":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "36a5587b74b659d7";
...
},{}],"hAZd0":[function(require,module,exports) {
...
// створює розмітку
function createFavNewsMarkUp({ id , urlMedia , section , title , abstract , published_date , url ,  }) {
    return `
...
<path d="M3.66536 0C1.8247 0 0.332031 1.47733 0.332031 3.3C0.332031 4.77133 0.915365 8.26333 6.65736 11.7933C6.76022 11.8559 6.8783 11.889 6.9987 11.889C7.1191 11.889 7.23718 11.8559 7.34003 11.7933C13.082 8.26333 13.6654 4.77133 13.6654 3.3C13.6654 1.47733 12.1727 0 10.332 0C8.49136 0 6.9987 2 6.9987 2C6.9987 2 5.50603 0 3.66536 0Z" fill="#4B48DA"/>
        ...
        <div class="news-card__text">
          <h2 class="news-card__title">${(0, _newsTextHiding.textHiding)(title, 30)}</h2>
          <p class="news-card__description">${(0, _newsTextHiding.textHiding)(abstract, 65)}</p>
        </div>
...
function onRemoveFromFavClick(e) {
    ...
    for(let i = 0; i < favorites.length; i += 1)if (favorites[i].url === url) favorites.splice(i, 1);
    saveRemoved(KEY_FAV_NEWS, favorites);
    card.remove();
    if (favorites == null || favorites.length === 0) (0, _markup.nothingFound)();
}
// додавання у read
...
},{"./header":"bvS82","./news-text-hiding":"jrucD","./markup":"3TIfq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bvS82":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./markup":"3TIfq","date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["abNf4","hAZd0"], "hAZd0", "parcelRequire7309")

//# sourceMappingURL=favourite.74b659d7.js.map
